...
def run_Lsharp(alphabet: list, sul: SUL, eq_oracle: Oracle,
               extension_rule='SepSeq', separation_rule="ADS", samples=None,
               max_learning_rounds=None, cache_and_non_det_check=True, return_data=False, print_level=2, budget=None):
    """
    ...
    ob_tree = ObservationTree(alphabet, sul, 'mealy', extension_rule, separation_rule)
