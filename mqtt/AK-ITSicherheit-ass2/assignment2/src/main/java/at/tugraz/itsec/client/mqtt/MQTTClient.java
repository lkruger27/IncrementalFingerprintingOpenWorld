package at.tugraz.itsec.client.mqtt;

import at.tugraz.itsec.client.data.*;
import at.tugraz.itsec.client.packets.*;
...
public class MQTTClient {
    ...
    public void connectToBroker(boolean cleanStart, boolean useWill) throws IOException {
        connectToBroker(cleanStart, useWill ? this.will : null);
    }
    ...
    protected boolean deleteRetained() throws IOException {
